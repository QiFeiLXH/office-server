...
public class ProjectLevelDepTypeByMonthVO {
    private Integer id;
    ...
    @ExcelProperty(value = "季度", index = 21)
    private String quarter;//季度
    @ExcelProperty(value = "核算月份", index = 22)
    ...
    @ExcelProperty(value = "产生部门类别", index = 23)
    private String depTypeText;//部门类型名称
    @ExcelProperty(value = "人力成本工作量", index = 24)
    private Double workload;//人力成本工作量
    @ExcelProperty(value = "人力成本金额", index = 25)
    private Double manpowerCost;//人力成本金额
    @ExcelProperty(value = "报销费用", index = 26)
    private Double expenses;//报销费用
    @ExcelProperty(value = "项目奖金", index = 27)
