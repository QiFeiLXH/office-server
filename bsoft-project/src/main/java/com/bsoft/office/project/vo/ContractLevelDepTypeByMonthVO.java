 ...
 * @Version 1.0
 * @Description 统计报表：项目级-按部门类型-月度
 */
@Data
@ExcelIgnoreUnannotated
public class ContractLevelDepTypeByMonthVO{
    private Integer id;
    ...
    @ExcelProperty(value = "季度", index = 15)
    private String quarter;//季度
    @ExcelProperty(value = "核算月份", index = 16)
    ...
    @ExcelProperty(value = "产生部门类别", index = 17)
    private String depTypeText;//部门类型名称
    @ExcelProperty(value = "人力成本工作量", index = 18)
    private Double workload;//人力成本工作量
    @ExcelProperty(value = "人力成本金额", index = 19)
    private Double manpowerCost;//人力成本金额
    @ExcelProperty(value = "报销费用", index = 20)
    private Double expenses;//报销费用
    @ExcelProperty(value = "项目奖金", index = 21)
