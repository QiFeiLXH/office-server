 ...
 * @Description 合同级-项目奖金-按产生部门类别-月度
 */
@Data
@ExcelIgnoreUnannotated
public class ContractLevelBonusDepTypeByMonthVO{
