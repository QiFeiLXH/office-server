...
public class ContractLevelManPowerMoneyAllByDepByMonthVO implements Serializable {
    ...
    @ExcelProperty(value = "人力成本金额年度", index = 17)
    private String YEAR;
    @ExcelProperty(value = "人力成本金额核算月份", index = 18)
