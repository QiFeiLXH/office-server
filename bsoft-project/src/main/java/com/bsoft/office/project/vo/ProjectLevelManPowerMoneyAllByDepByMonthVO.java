...
public class ProjectLevelManPowerMoneyAllByDepByMonthVO implements Serializable {
    ...
    @ExcelProperty(value = "人力成本金额产生部门类别", index = 22)
    private String DEPTYPE;
    @ExcelProperty(value = "人力成本金额年度", index = 23)
    private String YEAR;
    @ExcelProperty(value = "人力成本金额核算月份", index = 24)
