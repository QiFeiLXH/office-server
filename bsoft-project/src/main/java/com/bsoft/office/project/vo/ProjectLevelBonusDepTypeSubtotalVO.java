 ...
 * @Description 项目级-项目奖金-按产生部门类别-小计
 */
@Data
@ExcelIgnoreUnannotated
public class ProjectLevelBonusDepTypeSubtotalVO {
    ...
    @ExcelProperty(value = "项目奖金产生部门类别", index = 21)
    private String depTypeText;//项目奖金产生部门类别名称
    @ExcelProperty(value = "项目奖金", index = 22)
