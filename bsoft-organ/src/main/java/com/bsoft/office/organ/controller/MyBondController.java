 ...
 * @Description 我的保证金逾期情况查询
 */
@RestController
@RequestMapping("/mybond")
public class MyBondController {
    private static Logger logger  = LoggerFactory.getLogger(MyBondController.class);
    ...
    @OperLog(operType = OperLogType.QUERY,operDesc = "个人保证金逾期情况")
