...
public class OwnPurchaseContractViewVO {
    /** 采购id */
    ...
    /** 签定部门名称 */
    @ExcelProperty(value = "签定部门", index = 3)
    ...
    /** 对方单位名称 */
    @ExcelProperty(value = "对方单位", index = 4)
    ...
    @ExcelProperty(value = "有无合同", index = 0)
    @OperLogFieldName(value = "有无合同")
    ...
    /** 已支付金额 */
    @ExcelProperty(value = "已支付金额", index = 7)
    ...
    /** 决算金额 */
    @ExcelProperty(value = "决算金额", index = 6)
