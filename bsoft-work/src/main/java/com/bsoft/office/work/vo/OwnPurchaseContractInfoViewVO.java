...
public class OwnPurchaseContractInfoViewVO {
    /** 采购id */
    ...
    /** 已支付金额 */
    @ExcelProperty(value = "累计已支付金额", index = 5)
    ...
    /** 决算金额 */
    @ExcelProperty(value = "决算金额", index = 4)
    ...
    /** 合同进度 */
    @ExcelProperty(value = "进度", index = 7)
    @NumberFormat("#.##%")
    @OperLogFieldName(value = "合同进度")
    private Double progress;
    /** 合同确认日期 */
    @JsonFormat(pattern="yyyy-MM-dd",timezone = "GMT+8")
    @ExcelProperty(value = "进度确认日期", index = 8)
    ...
    /** 本期支付金额 */
    @ExcelProperty(value = "本期支付金额", index = 6)
    @OperLogFieldName(value = "本期支付金额")
